...
export const alt = "Shape the room around your team. Hands-on AI workshops for teams from the Tinker Pledge."
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>Hands-on AI workshops for teams</span>
          <span style={{ color: colors.gold }}>tinkerpledge.org/workplace</span>
        </div>
      </div>
    ),
