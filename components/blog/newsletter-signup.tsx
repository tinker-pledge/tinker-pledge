...
export function NewsletterSignup({ className }: { className?: string }) {
  return (
    <section
      ...
      className={cn('rounded-2xl border border-border/70 bg-card p-7', className)}
    >
      <h2 id="newsletter-heading" className="font-serif text-xl text-foreground">
      ...
      >
        <div className="flex flex-1 flex-col gap-1.5">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
          />
        </div>
